...
/* harmony export */   "S9": () => (/* binding */ QuestionButton),
/* harmony export */   "J$": () => (/* binding */ EndGameButtons)
/* harmony export */ });
...
`;
const QuestionButton = (styled_components__WEBPACK_IMPORTED_MODULE_0___default().div)`
border-radius: 8px;
cursor: pointer;
color: #2988D6;
...
`;
const EndGameButtons = (styled_components__WEBPACK_IMPORTED_MODULE_0___default().div)`
border-radius: 8px;
cursor: pointer;
color: #1C1C1C;
width: max-content;
